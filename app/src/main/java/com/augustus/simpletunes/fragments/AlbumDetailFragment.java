...
package com.augustus.simpletunes.fragments;
...
import com.augustus.simpletunes.adapters.AlbumSongsAdapter;
import com.augustus.simpletunes.dataloaders.AlbumLoader;
import com.augustus.simpletunes.dataloaders.AlbumSongLoader;
import com.augustus.simpletunes.dialogs.AddPlaylistDialog;
import com.augustus.simpletunes.listeners.SimplelTransitionListener;
import com.augustus.simpletunes.models.Album;
import com.augustus.simpletunes.models.Song;
import com.augustus.simpletunes.utils.ATEUtils;
import com.augustus.simpletunes.utils.Constants;
import com.augustus.simpletunes.utils.FabAnimationUtils;
...
import com.augustus.simpletunes.utils.SortOrder;
...
public class AlbumDetailFragment extends Fragment {
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        TunesPlayer.playAll(getActivity(), adapter.getSongIds(), 0, albumID, TunesUtils.IdType.Album, true);
        ...
        ImageUtils.loadAlbumArtIntoView(album.id, albumArt, new ImageLoadingListener() {
                    ...
                    public void onLoadingFailed(String imageUri, View view, FailReason failReason) {
                        ...
                        MaterialDrawableBuilder builder = MaterialDrawableBuilder.with(context)
                                ...
                                .setColor(TunesUtils.getBlackWhiteColor(Config.accentColor(context, Helpers.getATEKey(context))));
                                                                          ...
                                                                          public void onGenerated(Palette palette) {
                                                                              ...
                                                                              if (getActivity() != null) {
                                                                                  MaterialDrawableBuilder builder = MaterialDrawableBuilder.with(getActivity())
                                                                                          ...
                                                                                          .setSizeDp(30);
                                                                                  if (primaryColor != -1) {
                                                                                      builder.setColor(TunesUtils.getBlackWhiteColor(primaryColor));
                                                                                      ATEUtils.setFabBackgroundTint(fab, primaryColor);
                                                                                      fab.setImageDrawable(builder.build());
                                                                                  } else {
                                                                                      if (context != null) {
                                                                                          ATEUtils.setFabBackgroundTint(fab, Config.accentColor(context, Helpers.getATEKey(context)));
                                                                                          builder.setColor(TunesUtils.getBlackWhiteColor(Config.accentColor(context, Helpers.getATEKey(context))));
                                                                                          fab.setImageDrawable(builder.build());
                                                                                      }
                                                                                  }
                                                                              }
    ...
    private void setAlbumDetails() {
        ...
        String songCount = TunesUtils.makeLabel(getActivity(), R.plurals.Nsongs, album.songCount);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.popup_song_addto_queue:
                TunesPlayer.addToQueue(context, mAdapter.getSongIds(), -1, TunesUtils.IdType.NA);
                break;
