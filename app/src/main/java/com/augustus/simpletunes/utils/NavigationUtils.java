...
package com.augustus.simpletunes.utils;
...
import com.augustus.simpletunes.activities.MainActivity;
import com.augustus.simpletunes.activities.NowPlayingActivity;
import com.augustus.simpletunes.activities.PlaylistDetailActivity;
import com.augustus.simpletunes.activities.SearchActivity;
import com.augustus.simpletunes.activities.SettingsActivity;
import com.augustus.simpletunes.fragments.AlbumDetailFragment;
import com.augustus.simpletunes.fragments.ArtistDetailFragment;
import com.augustus.simpletunes.nowplaying.Timber1;
import com.augustus.simpletunes.nowplaying.Timber2;
import com.augustus.simpletunes.nowplaying.Timber3;
import com.augustus.simpletunes.nowplaying.Timber4;
import com.augustus.simpletunes.nowplaying.Timber5;
import com.augustus.simpletunes.nowplaying.Timber6;
...
public class NavigationUtils {
    ...
    public static void navigateToPlaylistDetail(Activity context, String action, long firstAlbumID, String playlistName, int foregroundcolor, long playlistID, ArrayList<Pair> transitionViews) {
        ...
        if (transitionViews != null && TunesUtils.isLollipop()) {
    ...
    public static void navigateToEqualizer(Activity context) {
        try {
            ...
            context.startActivityForResult(TunesUtils.createEffectsIntent(), 666);
