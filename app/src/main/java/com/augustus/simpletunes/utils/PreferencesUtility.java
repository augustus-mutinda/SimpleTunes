...
public final class PreferencesUtility {
    ...
    public void updateService(Bundle extras) {
        if(!TunesPlayer.isPlaybackServiceConnected())return;
        final Intent intent = new Intent(context, TunesService.class);
        intent.setAction(TunesService.UPDATE_PREFERENCES);
