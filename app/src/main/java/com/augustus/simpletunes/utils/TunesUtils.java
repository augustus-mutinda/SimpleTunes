...
import com.augustus.simpletunes.adapters.BaseSongAdapter;
...
public class TunesUtils {
    ...
    public static Intent createEffectsIntent() {
        ...
        effects.putExtra(AudioEffect.EXTRA_AUDIO_SESSION, TunesPlayer.getAudioSessionId());
        return effects;
    }
        ...
        new MaterialDialog.Builder(context)
                ...
                .onPositive(new MaterialDialog.SingleButtonCallback() {
                    ...
                    public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                        TunesUtils.deleteTracks(context, list);
