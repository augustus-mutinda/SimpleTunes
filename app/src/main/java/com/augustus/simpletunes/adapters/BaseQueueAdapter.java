...
public class BaseQueueAdapter extends RecyclerView.Adapter<BaseQueueAdapter.ItemHolder> {
    ...
    public BaseQueueAdapter(AppCompatActivity context, List<Song> arraylist) {
        ...
        currentlyPlayingPosition = TunesPlayer.getQueuePosition();
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            case R.id.popup_song_play:
                                TunesPlayer.playAll(mContext, getSongIds(), position, -1, TunesUtils.IdType.NA, false);
                                break;
                            ...
                            case R.id.popup_song_delete:
                                ...
                                TunesUtils.showDeleteDialog(mContext,arraylist.get(position).title, deleteIds, BaseQueueAdapter.this, position);
                                break;
                        }
                        return false;
                    }
    ...
    public class ItemHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    TunesPlayer.setQueuePosition(getAdapterPosition());
