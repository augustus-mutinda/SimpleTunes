...
public class ArtistAdapter extends RecyclerView.Adapter<ArtistAdapter.ItemHolder> implements BubbleTextGetter {
    ...
    public void onBindViewHolder(final ItemHolder itemHolder, int i) {
        ...
        String albumNmber = TunesUtils.makeLabel(mContext, R.plurals.Nalbums, localItem.albumCount);
        String songCount = TunesUtils.makeLabel(mContext, R.plurals.Nsongs, localItem.songCount);
        itemHolder.albums.setText(TunesUtils.makeCombinedString(mContext, albumNmber, songCount));
