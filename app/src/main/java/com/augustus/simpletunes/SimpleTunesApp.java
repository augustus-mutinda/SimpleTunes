...
public class SimpleTunesApp extends MultiDexApplication {


    private static SimpleTunesApp mInstance;

    public static synchronized SimpleTunesApp getInstance() {
        return mInstance;
    }
    ...
    public void onCreate() {
        ...
        ImageLoaderConfiguration localImageLoaderConfiguration = new ImageLoaderConfiguration.Builder(this).imageDownloader(new BaseImageDownloader(this) {
            PreferencesUtility prefs = PreferencesUtility.getInstance(SimpleTunesApp.this);
