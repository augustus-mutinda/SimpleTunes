...
import com.augustus.simpletunes.utils.LyricsExtractor;
import com.augustus.simpletunes.utils.LyricsLoader;
...
public class LyricsFragment extends Fragment {
    ...
    private void loadLyrics() {
        ...
        String filename = getRealPathFromURI(Uri.parse(MediaStore.Audio.Media.EXTERNAL_CONTENT_URI + "/" + TunesPlayer.getCurrentAudioId()));
        ...
        if (lyrics != null) {
            ...
            if (artist != null) {
                ...
                LyricsLoader.getInstance(this.getContext()).getLyrics(artist, TunesPlayer.getTrackName(), new Callback<String>() {
                    @Override
    ...
    private void setupToolbar() {
        ...
        if (TunesPlayer.getTrackName() != null) {
            ab.setTitle(TunesPlayer.getTrackName());
        }
    }
