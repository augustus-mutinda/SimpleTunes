...
public class MusicPlaybackTrack implements Parcelable {
    ...
    public TunesUtils.IdType mSourceType;
    public int mSourcePosition;

    public MusicPlaybackTrack(long id, long sourceId, TunesUtils.IdType type, int sourcePosition) {
        mId = id;
        mSourceId = sourceId;
        mSourceType = type;
    ...
    public MusicPlaybackTrack(Parcel in) {
        ...
        mSourceType = TunesUtils.IdType.getTypeById(in.readInt());
