...
import com.augustus.simpletunes.fragments.AlbumFragment;
import com.augustus.simpletunes.fragments.ArtistFragment;
import com.google.android.gms.cast.framework.media.widget.ExpandedControllerActivity;
import com.augustus.simpletunes.TunesPlayer;
import com.augustus.simpletunes.R;
import com.augustus.simpletunes.cast.ExpandedControlsActivity;
import com.augustus.simpletunes.fragments.FoldersFragment;
import com.augustus.simpletunes.fragments.MainFragment;
import com.augustus.simpletunes.fragments.PlaylistFragment;
import com.augustus.simpletunes.fragments.QueueFragment;
import com.augustus.simpletunes.permissions.Nammu;
import com.augustus.simpletunes.permissions.PermissionCallback;
import com.augustus.simpletunes.slidinguppanel.SlidingUpPanelLayout;
import com.augustus.simpletunes.subfragments.LyricsFragment;
...
public class MainActivity extends BaseActivity implements ATEActivityThemeCustomizer {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (Intent.ACTION_VIEW.equals(action)) {
            ...
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    TunesPlayer.clearQueue();
                    TunesPlayer.openFile(Objects.requireNonNull(getIntent().getData()).getPath());
        ...
        if (!panelLayout.isPanelHidden() && TunesPlayer.getTrackName() == null) {
    ...
    public void setDetailsToHeader() {
        String name = TunesPlayer.getTrackName();
        String artist = TunesPlayer.getArtistName();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Objects.requireNonNull(getSupportFragmentManager().findFragmentById(R.id.fragment_container)).onActivityResult(requestCode, resultCode, data);
    }
